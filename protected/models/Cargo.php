...
class Cargo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombre_cargo', 'length', 'max'=>250),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_cargo, nombre_cargo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'indicadors' => array(self::HAS_MANY, 'Indicador', 'id_cargo_responsable'),
			'accions' => array(self::HAS_MANY, 'Accion', 'id_cargo_ejecutante'),
		);
	}
