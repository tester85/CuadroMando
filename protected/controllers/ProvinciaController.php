...
class ProvinciaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->nombre_provincia = $_POST['nombre'];
			$model->no_provincia = $_POST['numero']; 
			if($model->save())
				echo 'true'; 
				else echo 'false'; 
		}
	...
	{		 
		...
		{
			if($this->loadModel($_POST['id_provincia'])->delete())
			echo 'true';
		}
			else echo 'false';			 
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Provincia');
	...
	{
		$model=Provincia::model()->findByPk((int)$id);
		if($model===null)
