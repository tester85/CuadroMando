...
class DocumentosController extends Controller
{
	...
	{
		$model=Documentos::model()->findByPk((int)$id);
		if($model===null)
	...
	public function SubirArchivos(){
		 print_r('Llego aca'); die;
			$nombre_completo = split('[.]',$_FILES['file']['name']); 
			$_FILES['file']['name'] = $nombre_completo[0].".".$nombre_completo[count($nombre_completo)-1]; 
			$destination = Yii::app()->baseUrl."/Documentos/".$_FILES['file']['name'];  
