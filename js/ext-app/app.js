...
Ext.ga.App = function(config) {
	...
	Ext.ga.App.superclass.constructor.apply(this, arguments);
}

Ext.extend(Ext.ga.App, Ext.util.Observable, {
	...
	*/
	api: { url: null, type: null, actions: {} },
	...
	*/
	...
	{
		var delay = 1; // <-- default delay of msg box is 1 second.

		if (status == false)
			delay = 3; // <-- when status is error, msg box delay is 3 seconds.
	...
	buildMessageBox: function(title, msg)
	{
		...
		'<div class="app-msg">',
			...
			'<div class="x-box-ml"><div class="x-box-mr"><div class="x-box-mc">',
				'<h3 class="x-icon-text icon-status-',title,'">',this.tr[title],'</h3>',
				msg,
			'</div></div></div>',
	...
	*/
	...
	/***
	* getViewState, alias for Ext.state.Manager.get
	* @param {Object} cmd
	*/
